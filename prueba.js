...
fetch("https://opentdb.com/api.php?amount=10&category=31&type=multiple")
    ...
    .then(data => {
            ...
            function printQuestions() {
                ...
                let correctAnswer = data.results[i].correct_answer; // --> La respuesta correcta sigue estando aquí
                let allAnswers = data.results[i].incorrect_answers; // --> Array con tres elementos
                let correctArr = correctAnswer.split();
                allAnswers.push(correctArr[i]); //Array de 4 elementos con las respuestas
